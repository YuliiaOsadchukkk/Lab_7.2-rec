...
int arrSearchCol(int** P, const int rowCount, const int colCount, int minEl, int i)
{
    ...
    if (i < rowCount - 2) 
    {
        arrSearchCol(P, rowCount, colCount, minEl, i + 2);
    }
    else
    {
        return minEl;
...
int main()
{
    ...
    cout << arrSearchCol(P, rowCount, colCount, minEl, 0) << endl;
